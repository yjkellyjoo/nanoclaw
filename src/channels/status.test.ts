...
describe('StatusChannel', () => {
  ...
  it('connect() throws when health check never succeeds', async () => {
    ...
    await expect(channel.connect()).rejects.toThrow(
      'status-backend not healthy after 24 retries',
    );
    expect(statusApiMocks.healthCheck).toHaveBeenCalledTimes(24);
  ...
  it('ownsJid() recognizes status dm and group JID formats', () => {
    ...
    expect(
      channel.ownsJid(
        '27dbdd24-0e5f-4c48-963d-da14567bbe0a-0x04357af6d167526f2388307c1b7de2c2c577908ac9126b33ae34cf0566a1bf37ed303150bec45453ad7bc56528cbf0354d26c08d611c931d63e73d677315cc4661',
      ),
    ).toBe(true);
